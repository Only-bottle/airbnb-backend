...
if DEBUG:
    ...
    DATABASES = {
        "default": dj_database_url.config(
            conn_max_age=600,  # DB 연결이 종료되기 전, 연결 유지 시간을 의미
        )
    }
...
if DEBUG:
    ...
    CORS_ALLOWED_ORIGINS = ["https://airbnb-frontend-poo2.onrender.com"]
    CSRF_TRUSTED_ORIGINS = ["https://airbnb-frontend-poo2.onrender.com"]
